...
<pre>
/opt/kibana/bin/kibana-plugin install https://github.com/sirensolutions/sentinl/releases/download/tag-5.2.2/sentinl-latest.tar.gz
</pre>
...
/opt/kibana/bin/kibana-plugin install  file://`pwd`/sentinl-latest.tar.gz
</pre>
